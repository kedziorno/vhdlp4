...
BEGIN SCHEMATIC
    ...
    BEGIN NETLIST
        ...
        BEGIN BLOCK XLXI_132 title
            ATTR TitleFieldText "  PATENT US 2004 0233075 A1 8B 10B ENCODER DECODER INCLUDING LOGIC GATES"
    ...
    BEGIN SHEET 1 3801 5382
        ...
        END INSTANCE
        BEGIN DISPLAY 1464 348 TEXT ?
            FONT 40 "Arial"
        END DISPLAY
        BEGIN DISPLAY 1464 2732 TEXT ?
            FONT 40 "Arial"
        END DISPLAY
        BEGIN DISPLAY 1464 2796 TEXT ?
            FONT 40 "Arial"
        END DISPLAY
        BEGIN DISPLAY 1464 1596 TEXT ?
            FONT 40 "Arial"
        END DISPLAY
    END SHEET
END SCHEMATIC
